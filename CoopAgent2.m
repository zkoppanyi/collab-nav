classdef CoopAgent2 < matlab.mixin.Copyable
    properties
    ...
    methods        
        ...
        function obj = CoopAgent2(id, x_init, P_init, t_init, max_neighbors, system_setting)
            ...
            if id ~= -1
                ...
                obj.x(obj.idxs) = x_init(1:obj.n_states);
                obj.q(obj.idxs) = x_init(1:obj.n_states);
            end
        ...
        function build_predict(obj)
            ...
            for j = 1 : obj.max_neighbors
                ...
                obj.F(lidxs,lidxs) = [1 0; 0 1];

                obj.f{lsidx+0} = @(x) x(lidxs(1));
                obj.f{lsidx+1} = @(x) x(lidxs(2));

                obj.Q(lidxs,lidxs) = diag([0.5, 0.5]);
